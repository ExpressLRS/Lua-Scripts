...
-- from the 137px half up to the 275px full, and the builder takes the largest
-- font the zone's height budget affords.
WidgetUI.fonts = {
  compact = { hero = SMLSIZE },
  third = { hero = BOLD },
  half = { hero = BOLD },
  full = { heroLadder = { XXLSIZE, DBLSIZE, MIDSIZE, BOLD } },
}
