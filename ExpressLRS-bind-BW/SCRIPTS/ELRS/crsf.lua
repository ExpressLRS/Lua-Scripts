...
-- B&W radios may omit parts of the standard table library.
...
function CRSF:fieldGetString(data, off)
  ...
  return tableConcat(data, nil, startOff, off - 1), off + 1
end
...
local function onElrsStatus(data)
  ...
  CRSF.elrsFlagsInfo = tableConcat(parts)
end
